...
CONTENT_BY_LABEL: dict[str, dict[str, list[str]]] = {
    ...
    # },
    labels[0] : {"texts" : ["중국식 냉면은 맛있어."], "images" : ["https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSDQTNcLoWz3ZnRq_A9JM2RDyoqEXzcXmlW9jkI8teyDw&s=10"]},
    labels[1] : {"texts" : ["짜장면은 맛있어."], "images" : ["https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQtXTJH1mbFW4sysxnFRcorh3OtBcDWTLl6Ne2yclVKCA&s=10"]},
